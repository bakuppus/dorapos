...
import com.dorapos.repository.ShopSectionRepository;
import com.dorapos.repository.search.ShopSectionSearchRepository;
import com.dorapos.service.ShopSectionService;
import com.dorapos.service.dto.ShopSectionDTO;
import com.dorapos.service.mapper.ShopSectionMapper;
...
/**
 * Integration tests for the {@Link ShopSectionResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class ShopSectionResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.ShopSectionSearchRepositoryMockConfiguration
     */
    @Autowired
