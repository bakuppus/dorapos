...
import com.dorapos.domain.Orders;
...
import com.dorapos.repository.OrdersRepository;
import com.dorapos.repository.search.OrdersSearchRepository;
import com.dorapos.service.OrdersService;
import com.dorapos.service.dto.OrdersDTO;
import com.dorapos.service.mapper.OrdersMapper;
import com.dorapos.web.rest.errors.ExceptionTranslator;
import com.dorapos.service.dto.OrdersCriteria;
import com.dorapos.service.OrdersQueryService;
...
public class OrdersResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.OrdersSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllOrdersByOrdersLinesIsEqualToSomething() throws Exception {
        // Initialize the database
        OrdersLine ordersLines = OrdersLineResourceIT.createEntity(em);
    ...
    public void getAllOrdersBySoldByIsEqualToSomething() throws Exception {
        // Initialize the database
        Profile soldBy = ProfileResourceIT.createEntity(em);
        em.persist(soldBy);
        em.flush();
    ...
    public void getAllOrdersByPreparedByIsEqualToSomething() throws Exception {
        // Initialize the database
        Profile preparedBy = ProfileResourceIT.createEntity(em);
    ...
    public void getAllOrdersByShopDeviceIsEqualToSomething() throws Exception {
        // Initialize the database
        ShopDevice shopDevice = ShopDeviceResourceIT.createEntity(em);
    ...
    public void getAllOrdersBySectionTableIsEqualToSomething() throws Exception {
        // Initialize the database
        SectionTable sectionTable = SectionTableResourceIT.createEntity(em);
