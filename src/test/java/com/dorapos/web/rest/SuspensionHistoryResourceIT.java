...
import com.dorapos.repository.SuspensionHistoryRepository;
import com.dorapos.repository.search.SuspensionHistorySearchRepository;
import com.dorapos.service.SuspensionHistoryService;
import com.dorapos.service.dto.SuspensionHistoryDTO;
import com.dorapos.service.mapper.SuspensionHistoryMapper;
...
/**
 * Integration tests for the {@Link SuspensionHistoryResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class SuspensionHistoryResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.SuspensionHistorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllSuspensionHistoriesBySuspendedByIsEqualToSomething() throws Exception {
        // Initialize the database
        Profile suspendedBy = ProfileResourceIT.createEntity(em);
