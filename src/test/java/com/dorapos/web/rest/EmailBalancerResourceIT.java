...
import com.dorapos.repository.EmailBalancerRepository;
import com.dorapos.repository.search.EmailBalancerSearchRepository;
import com.dorapos.service.EmailBalancerService;
import com.dorapos.service.dto.EmailBalancerDTO;
import com.dorapos.service.mapper.EmailBalancerMapper;
...
/**
 * Integration tests for the {@Link EmailBalancerResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class EmailBalancerResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.EmailBalancerSearchRepositoryMockConfiguration
     */
    @Autowired
