...
import com.dorapos.DoraposApp;
import com.dorapos.domain.Shop;
import com.dorapos.domain.Company;
...
import com.dorapos.repository.ShopRepository;
import com.dorapos.repository.search.ShopSearchRepository;
import com.dorapos.service.ShopService;
import com.dorapos.service.dto.ShopDTO;
import com.dorapos.service.mapper.ShopMapper;
import com.dorapos.web.rest.errors.ExceptionTranslator;
import com.dorapos.service.dto.ShopCriteria;
import com.dorapos.service.ShopQueryService;
...
import static com.dorapos.web.rest.TestUtil.sameInstant;
import static com.dorapos.web.rest.TestUtil.createFormattingConversionService;
...
import com.dorapos.domain.enumeration.ShopAccountType;
/**
 * Integration tests for the {@Link ShopResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class ShopResourceIT {
    ...
    /**
     * This repository is mocked in the com.dorapos.repository.search test package.
     *
     * @see com.dorapos.repository.search.ShopSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllShopsByApprovedByIsEqualToSomething() throws Exception {
        // Initialize the database
        Profile approvedBy = ProfileResourceIT.createEntity(em);
    ...
    public void getAllShopsByProductCategoriesIsEqualToSomething() throws Exception {
        // Initialize the database
        ProductCategory productCategories = ProductCategoryResourceIT.createEntity(em);
    ...
    public void getAllShopsByProductTypesIsEqualToSomething() throws Exception {
        // Initialize the database
        ProductType productTypes = ProductTypeResourceIT.createEntity(em);
    ...
    public void getAllShopsBySystemConfigsIsEqualToSomething() throws Exception {
        // Initialize the database
        SystemConfig systemConfigs = SystemConfigResourceIT.createEntity(em);
    ...
    public void getAllShopsByDiscountsIsEqualToSomething() throws Exception {
        // Initialize the database
        Discount discounts = DiscountResourceIT.createEntity(em);
    ...
    public void getAllShopsByTaxesIsEqualToSomething() throws Exception {
        // Initialize the database
        Tax taxes = TaxResourceIT.createEntity(em);
        em.persist(taxes);
        em.flush();
        shop.addTaxes(taxes);
        shopRepository.saveAndFlush(shop);
