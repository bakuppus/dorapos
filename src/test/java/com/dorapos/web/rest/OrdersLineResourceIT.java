...
import com.dorapos.repository.OrdersLineRepository;
import com.dorapos.repository.search.OrdersLineSearchRepository;
import com.dorapos.service.OrdersLineService;
import com.dorapos.service.dto.OrdersLineDTO;
import com.dorapos.service.mapper.OrdersLineMapper;
...
/**
 * Integration tests for the {@Link OrdersLineResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class OrdersLineResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.OrdersLineSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllOrdersLinesByOrdersLineVariantsIsEqualToSomething() throws Exception {
        // Initialize the database
        OrdersLineVariant ordersLineVariants = OrdersLineVariantResourceIT.createEntity(em);
