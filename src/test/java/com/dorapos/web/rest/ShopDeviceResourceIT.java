...
import com.dorapos.repository.ShopDeviceRepository;
import com.dorapos.repository.search.ShopDeviceSearchRepository;
import com.dorapos.service.ShopDeviceService;
import com.dorapos.service.dto.ShopDeviceDTO;
import com.dorapos.service.mapper.ShopDeviceMapper;
...
/**
 * Integration tests for the {@Link ShopDeviceResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class ShopDeviceResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.ShopDeviceSearchRepositoryMockConfiguration
     */
    @Autowired
