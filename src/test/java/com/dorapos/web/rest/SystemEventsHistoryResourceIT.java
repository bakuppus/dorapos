...
import com.dorapos.repository.SystemEventsHistoryRepository;
import com.dorapos.repository.search.SystemEventsHistorySearchRepository;
import com.dorapos.service.SystemEventsHistoryService;
import com.dorapos.service.dto.SystemEventsHistoryDTO;
import com.dorapos.service.mapper.SystemEventsHistoryMapper;
...
public class SystemEventsHistoryResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.SystemEventsHistorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllSystemEventsHistoriesByTriggedByIsEqualToSomething() throws Exception {
        // Initialize the database
        Profile triggedBy = ProfileResourceIT.createEntity(em);
