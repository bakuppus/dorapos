...
import com.dorapos.repository.ShopChangeRepository;
import com.dorapos.repository.search.ShopChangeSearchRepository;
import com.dorapos.service.ShopChangeService;
import com.dorapos.service.dto.ShopChangeDTO;
import com.dorapos.service.mapper.ShopChangeMapper;
...
/**
 * Integration tests for the {@Link ShopChangeResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class ShopChangeResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.ShopChangeSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllShopChangesByChangedByIsEqualToSomething() throws Exception {
        // Initialize the database
        Profile changedBy = ProfileResourceIT.createEntity(em);
