...
import com.dorapos.repository.ProductRepository;
import com.dorapos.repository.search.ProductSearchRepository;
import com.dorapos.service.ProductService;
import com.dorapos.service.dto.ProductDTO;
import com.dorapos.service.mapper.ProductMapper;
import com.dorapos.web.rest.errors.ExceptionTranslator;
import com.dorapos.service.dto.ProductCriteria;
import com.dorapos.service.ProductQueryService;
...
public class ProductResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.ProductSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllProductsByVariantsIsEqualToSomething() throws Exception {
        // Initialize the database
        ProductVariant variants = ProductVariantResourceIT.createEntity(em);
        em.persist(variants);
        em.flush();
    ...
    public void getAllProductsByExtrasIsEqualToSomething() throws Exception {
        // Initialize the database
        ProductExtra extras = ProductExtraResourceIT.createEntity(em);
        em.persist(extras);
        em.flush();
    ...
    public void getAllProductsByCategoryIsEqualToSomething() throws Exception {
        // Initialize the database
        ProductCategory category = ProductCategoryResourceIT.createEntity(em);
        em.persist(category);
        em.flush();
