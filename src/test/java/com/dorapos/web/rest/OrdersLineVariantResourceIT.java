...
import com.dorapos.repository.OrdersLineVariantRepository;
import com.dorapos.repository.search.OrdersLineVariantSearchRepository;
import com.dorapos.service.OrdersLineVariantService;
import com.dorapos.service.dto.OrdersLineVariantDTO;
import com.dorapos.service.mapper.OrdersLineVariantMapper;
...
/**
 * Integration tests for the {@Link OrdersLineVariantResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class OrdersLineVariantResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.OrdersLineVariantSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllOrdersLineVariantsByOrdersLineIsEqualToSomething() throws Exception {
        // Initialize the database
        OrdersLine ordersLine = OrdersLineResourceIT.createEntity(em);
    ...
    public void getAllOrdersLineVariantsByOrdersLineExtrasIsEqualToSomething() throws Exception {
        // Initialize the database
        OrdersLineExtra ordersLineExtras = OrdersLineExtraResourceIT.createEntity(em);
