...
import com.dorapos.repository.SectionTableRepository;
import com.dorapos.repository.search.SectionTableSearchRepository;
import com.dorapos.service.SectionTableService;
import com.dorapos.service.dto.SectionTableDTO;
import com.dorapos.service.mapper.SectionTableMapper;
...
/**
 * Integration tests for the {@Link SectionTableResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class SectionTableResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.SectionTableSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllSectionTablesByShopSectionsIsEqualToSomething() throws Exception {
        // Initialize the database
        ShopSection shopSections = ShopSectionResourceIT.createEntity(em);
