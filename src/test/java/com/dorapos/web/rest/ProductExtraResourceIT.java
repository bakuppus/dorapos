...
import com.dorapos.repository.ProductExtraRepository;
import com.dorapos.repository.search.ProductExtraSearchRepository;
import com.dorapos.service.ProductExtraService;
import com.dorapos.service.dto.ProductExtraDTO;
import com.dorapos.service.mapper.ProductExtraMapper;
...
/**
 * Integration tests for the {@Link ProductExtraResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class ProductExtraResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.ProductExtraSearchRepositoryMockConfiguration
     */
    @Autowired
