...
import com.dorapos.repository.PaymentRepository;
import com.dorapos.repository.search.PaymentSearchRepository;
import com.dorapos.service.PaymentService;
import com.dorapos.service.dto.PaymentDTO;
import com.dorapos.service.mapper.PaymentMapper;
import com.dorapos.web.rest.errors.ExceptionTranslator;
import com.dorapos.service.dto.PaymentCriteria;
import com.dorapos.service.PaymentQueryService;
...
public class PaymentResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.PaymentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllPaymentsByProcessedByIsEqualToSomething() throws Exception {
        // Initialize the database
        Profile processedBy = ProfileResourceIT.createEntity(em);
