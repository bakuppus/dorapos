...
import com.dorapos.repository.OrdersLineExtraRepository;
import com.dorapos.repository.search.OrdersLineExtraSearchRepository;
import com.dorapos.service.OrdersLineExtraService;
import com.dorapos.service.dto.OrdersLineExtraDTO;
import com.dorapos.service.mapper.OrdersLineExtraMapper;
...
/**
 * Integration tests for the {@Link OrdersLineExtraResource} REST controller.
 */
@SpringBootTest(classes = DoraposApp.class)
public class OrdersLineExtraResourceIT {
     ...
     *
     * @see com.dorapos.repository.search.OrdersLineExtraSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllOrdersLineExtrasByOrdersLineVariantIsEqualToSomething() throws Exception {
        // Initialize the database
        OrdersLineVariant ordersLineVariant = OrdersLineVariantResourceIT.createEntity(em);
