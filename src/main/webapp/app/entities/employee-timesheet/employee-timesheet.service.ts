...
export class EmployeeTimesheetService {
  ...
  protected convertDateFromClient(employeeTimesheet: IEmployeeTimesheet): IEmployeeTimesheet {
    const copy: IEmployeeTimesheet = Object.assign({}, employeeTimesheet, {
      checkinTime:
        employeeTimesheet.checkinTime != null && employeeTimesheet.checkinTime.isValid() ? employeeTimesheet.checkinTime.toJSON() : null,
      checkOutTime:
        employeeTimesheet.checkOutTime != null && employeeTimesheet.checkOutTime.isValid() ? employeeTimesheet.checkOutTime.toJSON() : null
    });
    return copy;
  }
