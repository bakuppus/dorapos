...
/**
 * REST controller for managing {@link com.dorapos.domain.Shop}.
 */
@RestController
@RequestMapping("/api")
public class ShopResource {
     ...
     */
    @GetMapping("/shops")
    public ResponseEntity<List<ShopDTO>> getAllShops(ShopCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<ShopDTO>> searchShops(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
