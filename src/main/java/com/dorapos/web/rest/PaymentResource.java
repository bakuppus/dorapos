...
/**
 * REST controller for managing {@link com.dorapos.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
public class PaymentResource {
    ...
    */
    ...
    public ResponseEntity<List<PaymentDTO>> searchPayments(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
