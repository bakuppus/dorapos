...
/**
 * REST controller for managing {@link com.dorapos.domain.Orders}.
 */
@RestController
@RequestMapping("/api")
public class OrdersResource {
     ...
     */
    @GetMapping("/orders")
    public ResponseEntity<List<OrdersDTO>> getAllOrders(OrdersCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<OrdersDTO>> searchOrders(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
