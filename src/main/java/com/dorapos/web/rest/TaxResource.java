...
/**
 * REST controller for managing {@link com.dorapos.domain.Tax}.
 */
@RestController
@RequestMapping("/api")
public class TaxResource {
     ...
     */
    @GetMapping("/taxes")
    public ResponseEntity<List<TaxDTO>> getAllTaxes(TaxCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<TaxDTO>> searchTaxes(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
