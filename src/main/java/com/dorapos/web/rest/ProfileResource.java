...
/**
 * REST controller for managing {@link com.dorapos.domain.Profile}.
 */
@RestController
@RequestMapping("/api")
public class ProfileResource {
    ...
    */
    ...
    public ResponseEntity<List<ProfileDTO>> searchProfiles(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
