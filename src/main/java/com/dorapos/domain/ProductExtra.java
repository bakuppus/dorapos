...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "productextra")
public class ProductExtra implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductExtra)) {
            return false;
        }
        return id != null && id.equals(((ProductExtra) o).id);
    }
