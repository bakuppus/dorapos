...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "orderslineextra")
public class OrdersLineExtra implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrdersLineExtra)) {
            return false;
        }
        return id != null && id.equals(((OrdersLineExtra) o).id);
    }
