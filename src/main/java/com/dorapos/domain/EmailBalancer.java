...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "emailbalancer")
public class EmailBalancer implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmailBalancer)) {
            return false;
        }
        return id != null && id.equals(((EmailBalancer) o).id);
    }
