...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "suspensionhistory")
public class SuspensionHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SuspensionHistory)) {
            return false;
        }
        return id != null && id.equals(((SuspensionHistory) o).id);
    }
