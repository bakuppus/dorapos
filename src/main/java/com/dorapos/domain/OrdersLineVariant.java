...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "orderslinevariant")
public class OrdersLineVariant implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrdersLineVariant)) {
            return false;
        }
        return id != null && id.equals(((OrdersLineVariant) o).id);
    }
