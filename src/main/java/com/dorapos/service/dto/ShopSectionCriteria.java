...
/**
 * Criteria class for the {@link com.dorapos.domain.ShopSection} entity. This class is used
 * in {@link com.dorapos.web.rest.ShopSectionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /shop-sections?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ShopSectionCriteria implements Serializable, Criteria {
    ...
    public ShopSectionCriteria(ShopSectionCriteria other){
        this.id = other.id == null ? null : other.id.copy();
        this.sectionName = other.sectionName == null ? null : other.sectionName.copy();
        this.description = other.description == null ? null : other.description.copy();
        this.surchargePercentage = other.surchargePercentage == null ? null : other.surchargePercentage.copy();
        this.surchargeFlatAmount = other.surchargeFlatAmount == null ? null : other.surchargeFlatAmount.copy();
        this.usePercentage = other.usePercentage == null ? null : other.usePercentage.copy();
        this.shopId = other.shopId == null ? null : other.shopId.copy();
    }

    @Override
    public ShopSectionCriteria copy() {
        return new ShopSectionCriteria(this);
    }
