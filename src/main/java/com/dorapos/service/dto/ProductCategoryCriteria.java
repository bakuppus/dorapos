...
/**
 * Criteria class for the {@link com.dorapos.domain.ProductCategory} entity. This class is used
 * in {@link com.dorapos.web.rest.ProductCategoryResource} to receive all the possible filtering options from
...
public class ProductCategoryCriteria implements Serializable, Criteria {
    ...
    public ProductCategoryCriteria(ProductCategoryCriteria other){
        ...
        this.imageFullUrl = other.imageFullUrl == null ? null : other.imageFullUrl.copy();
        this.imageThumbUrl = other.imageThumbUrl == null ? null : other.imageThumbUrl.copy();
