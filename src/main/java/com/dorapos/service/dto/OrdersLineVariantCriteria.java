...
/**
 * Criteria class for the {@link com.dorapos.domain.OrdersLineVariant} entity. This class is used
 * in {@link com.dorapos.web.rest.OrdersLineVariantResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /orders-line-variants?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class OrdersLineVariantCriteria implements Serializable, Criteria {
    ...
    public OrdersLineVariantCriteria(OrdersLineVariantCriteria other){
        this.id = other.id == null ? null : other.id.copy();
        this.variantName = other.variantName == null ? null : other.variantName.copy();
        this.variantValue = other.variantValue == null ? null : other.variantValue.copy();
        ...
        this.ordersLineId = other.ordersLineId == null ? null : other.ordersLineId.copy();
        this.ordersLineExtrasId = other.ordersLineExtrasId == null ? null : other.ordersLineExtrasId.copy();
    }

    @Override
    public OrdersLineVariantCriteria copy() {
        return new OrdersLineVariantCriteria(this);
    }
