...
/**
 * Criteria class for the {@link com.dorapos.domain.Shop} entity. This class is used
 * in {@link com.dorapos.web.rest.ShopResource} to receive all the possible filtering options from
...
public class ShopCriteria implements Serializable, Criteria {
    ...
    public static class ShopAccountTypeFilter extends Filter<ShopAccountType> {
        ...
        public ShopAccountTypeFilter() {
        }

        public ShopAccountTypeFilter(ShopAccountTypeFilter filter) {
            super(filter);
        }

        @Override
        public ShopAccountTypeFilter copy() {
            return new ShopAccountTypeFilter(this);
        }
    ...
    public ShopCriteria(ShopCriteria other){
        ...
        this.shopAccountType = other.shopAccountType == null ? null : other.shopAccountType.copy();
        this.approvalDate = other.approvalDate == null ? null : other.approvalDate.copy();
        this.address = other.address == null ? null : other.address.copy();
        this.email = other.email == null ? null : other.email.copy();
        this.description = other.description == null ? null : other.description.copy();
        this.note = other.note == null ? null : other.note.copy();
        this.landland = other.landland == null ? null : other.landland.copy();
        this.mobile = other.mobile == null ? null : other.mobile.copy();
        this.createdDate = other.createdDate == null ? null : other.createdDate.copy();
        this.shopLogoUrl = other.shopLogoUrl == null ? null : other.shopLogoUrl.copy();
        ...
        this.productCategoriesId = other.productCategoriesId == null ? null : other.productCategoriesId.copy();
        this.productTypesId = other.productTypesId == null ? null : other.productTypesId.copy();
        this.systemConfigsId = other.systemConfigsId == null ? null : other.systemConfigsId.copy();
